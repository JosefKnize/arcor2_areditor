...
public class HTransformMenu : Singleton<HTransformMenu>
{
    ...
    public void activeTransform(HInteractiveObject interactiveObject)
    {
        ...
        ////GizmoTransform.GetComponent<ObjectManipulator>().OnManipulationStarted.AddListener((s) => manipulationStarted = true); // TODO
        ...
        //    //objectManipulator.OnManipulationStarted.AddListener((s) => manipulationStarted = true); // TODO
        //    objectManipulator.firstSelectEntered.AddListener((s) => updatePosition());
